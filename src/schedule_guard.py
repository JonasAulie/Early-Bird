"""GitHub Actions cron is always UTC, but the desired run times (07:02,
07:32, 08:02) are in Oslo local time, which shifts between CET and CEST.
Rather than maintaining two sets of cron entries, the workflow fires at
every UTC time that could possibly correspond to one of the three slots
